...
The project currently has one interactive UI component. It is specific to the homepage prototype, but it contains the primary interaction pattern that future media components will build on.

## EditorialGrid

- Path: `components/editorial-grid.tsx`
- Description: Interactive editorial tile composition with GSAP Flip expansion and two authored layouts.
- Key props: None. Representative tile data is currently local to the component.
